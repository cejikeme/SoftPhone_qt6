...
public:
    ...
    virtual FileItem getItemByKey(std::string const& key);

    virtual FileItem getItemByKey(std::string const& section, std::string const& key);

    virtual std::string getSectionByKey(std::string const& key);

    virtual void getItemsBySection(std::string const& section, std::vector<FileItem>& fileItems);
